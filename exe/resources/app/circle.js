...
$("#calculateIntersectingAreaId").click(function () {
    ...
    $("#circleDataId input").each(function(){
        if( $(this).val() != ''){
            counterInputs += 1;
        }
    ...
    if(counterInputs != 7){
        ...
        //upper plate 1
        circleIntersecting.drawCircle(function () {
        }, 0, 0, upperR1, "#098d70", 5);
        //lower plate 2
        circleIntersecting.drawCircle(function () {
        }, 0, 0, lowerR2, "#ff2900", 5);
